...
, e._sentryDebugIds[t]="c37e44c3-059e-416c-ae50-3e3c6bff2952", e._sentryDebugIdIdentifier="sentry-dbid-c37e44c3-059e-416c-ae50-3e3c6bff2952")}
catch(e){
}
}
();
...
id:"7d113277e9203ca16d0d97799498275b2cd3c49d"}
, (()=>{
"use strict";
var e, t, n, r, o={
20597:e=>{
...
const n={
foundation:t[0], component:{
1:"rtp", 2:"rtcp"}
[t[1]]||t[1], protocol:t[2].toLowerCase(), priority:parseInt(t[3], 10), ip:t[4], address:t[4], port:parseInt(t[5], 10), type:t[7]}
;
for(let e=8;
e<t.length;
e+=2)switch(t[e]){
case"raddr":n.relatedAddress=t[e+1];
break;
case"rport":n.relatedPort=parseInt(t[e+1], 10);
break;
case"tcptype":n.tcpType=t[e+1];
break;
case"ufrag":n.ufrag=t[e+1], n.usernameFragment=t[e+1];
break;
...
return{
id:parseInt(t[0], 10), direction:t[0].indexOf("/")>0?t[0].split("/")[1]:"sendrecv", uri:t[1]}
}
...
for(let e=0;
e<r.length;
e++)n=r[e].trim().split("="), t[n[0].trim()]=n[1];
return t}
...
return{
semantics:t.shift(), ssrcs:t.map((e=>parseInt(e, 10)))}
}
, t.getMid=function(e){
...
return{
algorithm:t[0].toLowerCase(), value:t[1].toUpperCase()}
}
, t.getDtlsParameters=function(e, n){
return{
role:"auto", fingerprints:t.matchPrefix(e+n, "a=fingerprint:").map(t.parseFingerprint)}
}
...
const r=t.matchPrefix(e+n, "a=ice-ufrag:")[0], o=t.matchPrefix(e+n, "a=ice-pwd:")[0];
return r&&o?{
...
o<r.length;
o++){
const i=r[o], a=t.matchPrefix(e, "a=rtpmap:"+i+" ")[0];
if(a){
const r=t.parseRtpMap(a), o=t.matchPrefix(e, "a=fmtp:"+i+" ");
switch(r.parameters=o.length?t.parseFmtp(o[0]):{
}
, r.rtcpFeedback=t.matchPrefix(e, "a=rtcp-fb:"+i+" ").map(t.parseRtcpFb), n.codecs.push(r), r.name.toUpperCase()){
case"RED":case"ULPFEC":n.fecMechanisms.push(r.name.toUpperCase())}
}
}
...
let r="";
r+="m="+e+" ", r+=n.codecs.length>0?"9":"0", r+=" UDP/TLS/RTP/SAVPF ", r+=n.codecs.map((e=>void 0!==e.preferredPayloadType?e.preferredPayloadType:e.payloadType)).join(" ")+"\r\n", r+="c=IN IP4 0.0.0.0\r\n", r+="a=rtcp:9 IN IP4 0.0.0.0\r\n", n.codecs.forEach((e=>{
...
const n=[], r=t.parseRtpParameters(e), o=-1!==r.fecMechanisms.indexOf("RED"), i=-1!==r.fecMechanisms.indexOf("ULPFEC"), a=t.matchPrefix(e, "a=ssrc:").map((e=>t.parseSsrcMedia(e))).filter((e=>"cname"===e.attribute)), s=a.length>0&&a[0].ssrc;
let c;
const d=t.matchPrefix(e, "a=ssrc-group:FID").map((e=>e.substr(17).split(" ").map((e=>parseInt(e, 10)))));
d.length>0&&d[0].length>1&&d[0][0]===s&&(c=d[0][1]), r.codecs.forEach((e=>{
if("RTX"===e.name.toUpperCase()&&e.parameters.apt){
let t={
ssrc:s, codecPayloadType:parseInt(e.parameters.apt, 10)}
;
s&&c&&(t.rtx={
ssrc:c}
), n.push(t), o&&(t=JSON.parse(JSON.stringify(t)), t.fec={
ssrc:s, mechanism:i?"red+ulpfec":"red"}
, n.push(t))}
}
)), 0===n.length&&s&&n.push({
ssrc:s}
);
let p=t.matchPrefix(e, "b=");
return p.length&&(p=0===p[0].indexOf("b=TIAS:")?parseInt(p[0].substr(7), 10):0===p[0].indexOf("b=AS:")?1e3*parseInt(p[0].substr(5), 10)*.95-16e3:void 0, n.forEach((e=>{
e.maxBitrate=p}
))), n}
...
if(1===r.length)return n=r[0].substr(7).split(" "), {
stream:n[0], track:n[1]}
;
const o=t.matchPrefix(e, "a=ssrc:").map((e=>t.parseSsrcMedia(e))).filter((e=>"msid"===e.attribute));
return o.length>0?(n=o[0].value.split(" "), {
stream:n[0], track:n[1]}
):void 0}
, t.parseSctpDescription=function(e){
const n=t.parseMLine(e), r=t.matchPrefix(e, "a=max-message-size:");
let o;
r.length>0&&(o=parseInt(r[0].substr(19), 10)), isNaN(o)&&(o=65536);
const i=t.matchPrefix(e, "a=sctp-port:");
if(i.length>0)return{
port:parseInt(i[0].substr(12), 10), protocol:n.fmt, maxMessageSize:o}
;
const a=t.matchPrefix(e, "a=sctpmap:");
if(a.length>0){
const e=a[0].substr(10).split(" ");
return{
port:parseInt(e[0], 10), protocol:e[1], maxMessageSize:o}
}
}
...
return o=e||t.generateSessionId(), "v=0\r\no="+(r||"thisisadapterortc")+" "+o+" "+i+" IN IP4 127.0.0.1\r\ns=-\r\nt=0 0\r\n"}
, t.getDirection=function(e, n){
const r=t.splitLines(e);
for(let e=0;
e<r.length;
e++)switch(r[e]){
case"a=sendrecv":case"a=sendonly":case"a=recvonly":case"a=inactive":return r[e].substr(2)}
...
return{
kind:n[0], port:parseInt(n[1], 10), protocol:n[2], fmt:n.slice(3).join(" ")}
}
, t.parseOLine=function(e){
const n=t.matchPrefix(e, "o=")[0].substr(2).split(" ");
return{
username:n[0], sessionId:n[1], sessionVersion:parseInt(n[2], 10), netType:n[3], addressType:n[4], address:n[5]}
}
...
for(let e=0;
e<n.length;
e++)if(n[e].length<2||"="!==n[e].charAt(1))return!1;
return!0}
, e.exports=t}
, 65617:(e, t, n)=>{
n.d(t, {
...
const o=()=>!1, i=(e, t)=>{
var n;
return o()&&null!==(n=(0, r.v)(window.location.search)[e])&&void 0!==n?n:t}
}
, 37166:(e, t, n)=>{
n.d(t, {
v:()=>r}
);
const r=(e=window.location.search)=>e?Object.fromEntries(new URLSearchParams(e).entries()):{
}
}
}
, i={
...
s=t(s))Object.getOwnPropertyNames(s).forEach((e=>i[e]=()=>n[e]));
...
, a.e=e=>Promise.all(Object.keys(a.f).reduce(((t, n)=>(a.f[n](e, t), t)), [])), a.u=e=>"js/"+e+"_prod_"+{
89:"7350561b2c6a06a0b28f", 117:"20d5d0be6d7eadb614a7", 147:"6a82fe51528faebd90bd", 274:"9b91d18d9fad33cc6a49", 462:"2dd02c717c9aafb58f60", 467:"d9f04984a64392c29e06", 486:"7bccda748160fc7ba433", 557:"4652dba855adb99a538b", 558:"cc806ed309968821af22", 560:"6bdf17df3be3aa65c6e8", 573:"32872eb671786cc1d828", 593:"803db4017fef66c3d8c6", 595:"
[e]+".js", a.miniCssF=e=>"css/"+e+"_prod_"+{
573:"15d800f57f460c235c6c", 2635:"8dd93edebfd91a7250d0", 3238:"feb1cf83891db956f49a", 3330:"6182c77c26dfd61e186c", 3390:"98a669e3fd56635fe3d6", 4574:"7aa2254f94fae3f0a6b5", 8298:"e7439403182c06bcfc11", 8659:"c21f90631805af422c5c", 9089:"c1dbec8c6a8a0bda1e7b"}
[e]+".css", a.g=function(){
...
(), a.o=(e, t)=>Object.prototype.hasOwnProperty.call(e, t), n={
}
, r="duolingo-english-test-deployment:", a.l=(e, t, o, i)=>{
if(n[e])n[e].push(t);
else{
var s, c;
if(void 0!==o)for(var d=document.getElementsByTagName("script"), p=0;
p<d.length;
p++){
var f=d[p];
...
573:1, 2635:1, 3238:1, 3330:1, 3390:1, 4574:1, 8298:1, 8659:1, 9089:1}
[t]&&n.push(e[t]=(e=>new Promise(((t, n)=>{
var r=a.miniCssF(e), o=a.p+r;
if(((e, t)=>{
...
var a=n&&("load"===n.type?"missing":n.type), s=n&&n.target&&n.target.href||t, c=new Error("Loading CSS chunk "+e+" failed.\n("+s+")");
c.code="CSS_CHUNK_LOAD_FAILED", c.type=a, c.request=s, i.parentNode.removeChild(i), o(c)}
}
...
for(t&&t(n);
d<i.length;
d++)o=i[d], a.o(e, o)&&e[o]&&e[o][0](), e[o]=0}
, n=self.webpackChunkduolingo_english_test_deployment=self.webpackChunkduolingo_english_test_deployment||[];
...
;
a.r(e), a.d(e, {
fixNegotiationNeeded:()=>x, shimAddTrackRemoveTrack:()=>w, shimAddTrackRemoveTrackWithNative:()=>k, shimGetDisplayMedia:()=>v, shimGetSendersWithDtmf:()=>R, shimGetStats:()=>P, shimGetUserMedia:()=>g, shimMediaStream:()=>T, shimOnTrack:()=>S, shimPeerConnection:()=>E, shimSenderReceiverGetStats:()=>_}
);
var t={
}
;
a.r(t), a.d(t, {
shimAddTransceiver:()=>F, shimCreateAnswer:()=>G, shimCreateOffer:()=>z, shimGetDisplayMedia:()=>M, shimGetParameters:()=>U, shimGetUserMedia:()=>D, shimOnTrack:()=>O, shimPeerConnection:()=>I, shimRTCDataChannel:()=>N, shimReceiverGetStats:()=>L, shimRemoveStream:()=>A, shimSenderGetStats:()=>j}
);
var n={
}
;
a.r(n), a.d(n, {
shimAudioContext:()=>Y, shimCallbacksAPI:()=>B, shimConstraints:()=>W, shimCreateOfferLegacy:()=>H, shimGetUserMedia:()=>K, shimLocalStreamsAPI:()=>J, shimRTCIceServerUrls:()=>$, shimRemoteStreamsAPI:()=>V, shimTrackEventTransceiver:()=>q}
);
var r={
}
;
a.r(r), a.d(r, {
removeExtmapAllowMixed:()=>oe, shimAddIceCandidateNullOrEmpty:()=>ie, shimConnectionState:()=>re, shimMaxMessageSize:()=>te, shimParameterlessSetLocalDescription:()=>ae, shimRTCIceCandidate:()=>Z, shimRTCIceCandidateRelayProtocol:()=>ee, shimSendThrowTypeError:()=>ne}
);
var o=a(65617);
let i=!0, s=!0;
function c(e, t, n){
...
, this._eventMap[t]||(this._eventMap[t]=new Map), this._eventMap[t].set(r, i), o.apply(this, [e, i])}
;
...
function f(e){
return"boolean"!=typeof e?new Error("Argument type: "+typeof e+". Please use a boolean."):(s=!e, "adapter.js deprecation warnings "+(e?"disabled":"enabled"))}
function l(){
...
function m(e){
return h(e)?Object.keys(e).reduce((function(t, n){
const r=h(e[n]), o=r?m(e[n]):e[n], i=r&&!Object.keys(o).length;
return void 0===o||i?t:Object.assign(t, {
[n]:o}
)}
), {
}
...
r.endsWith("Id")?y(e, e.get(t[r]), n):r.endsWith("Ids")&&t[r].forEach((t=>{
y(e, e.get(t), n)}
))}
)))}
function b(e, t, n){
...
e.forEach((n=>{
n.type===r&&n.trackId===t.id&&y(e, n, o)}
))}
)), o}
const C=l;
function g(e, t){
...
;
"number"==typeof r.ideal?(e[o("min", n)]=r.ideal, t.optional.push(e), e={
}
, e[o("max", n)]=r.ideal, t.optional.push(e)):(e[o("", n)]=r.ideal, t.optional.push(e))}
void 0!==r.exact&&"number"!=typeof r.exact?(t.mandatory=t.mandatory||{
}
, t.mandatory[o("", n)]=r.exact):["min", "max"].forEach((e=>{
...
if(i&&("user"===i.exact||"environment"===i.exact||"user"===i.ideal||"environment"===i.ideal)&&(!n.mediaDevices.getSupportedConstraints||!n.mediaDevices.getSupportedConstraints().facingMode||a)){
let t;
if(delete e.video.facingMode, "environment"===i.exact||"environment"===i.ideal?t=["back", "rear"]:"user"!==i.exact&&"user"!==i.ideal||(t=["front"]), t)return n.mediaDevices.enumerateDevices().then((n=>{
let a=(n=n.filter((e=>"videoinput"===e.kind))).find((e=>t.some((t=>e.label.toLowerCase().includes(t)))));
return!a&&n.length&&t.includes("back")&&(a=n[n.length-1]), a&&(e.video.deviceId=i.exact?{
exact:a.deviceId}
:{
ideal:a.deviceId}
), e.video=r(e.video), C("chrome: "+JSON.stringify(e)), o(e)}
))}
e.video=r(e.video)}
...
return t(n).then((t=>{
const r=n.video&&n.video.width, o=n.video&&n.video.height, i=n.video&&n.video.frameRate;
return n.video={
mandatory:{
chromeMediaSource:"desktop", chromeMediaSourceId:t, maxFrameRate:i||3}
}
...
o.track=n.track, o.receiver=r, o.transceiver={
receiver:r}
, o.streams=[t.stream], this.dispatchEvent(o)}
...
const n={
id:e.id, timestamp:e.timestamp, type:{
...
const r=e._reverseStreams[t], o=e._streams[r.id];
...
, o.apply(this, [this._streams[e.id]||e]), delete this._reverseStreams[this._streams[e.id]?this._streams[e.id].id:e.id], delete this._streams[e.id]}
...
, arguments[2]]):n.apply(this, arguments).then((e=>i(this, e)))}
}
;
...
if("rid"in e&&!/^[a-z0-9]{
0, 16}
$/i.test(e.rid))throw new TypeError("Invalid RID value provided.");
...
function B(e){
if("object"!=typeof e||!e.RTCPeerConnection)return;
const t=e.RTCPeerConnection.prototype, n=t.createOffer, r=t.createAnswer, o=t.setLocalDescription, i=t.setRemoteDescription, a=t.addIceCandidate;
t.createOffer=function(e, t){
const r=arguments.length>=2?arguments[2]:arguments[0], o=n.apply(this, [r]);
return t?(o.then(e, t), Promise.resolve()):o}
, t.createAnswer=function(e, t){
const n=arguments.length>=2?arguments[2]:arguments[0], o=r.apply(this, [n]);
return t?(o.then(e, t), Promise.resolve()):o}
;
...
const t=[];
for(let n=0;
n<e.iceServers.length;
n++){
let r=e.iceServers[n];
!r.hasOwnProperty("urls")&&r.hasOwnProperty("url")?(u("RTCIceServer.url", "RTCIceServer.urls"), r=JSON.parse(JSON.stringify(r)), r.urls=r.url, delete r.url, t.push(r)):t.push(e.iceServers[n])}
e.iceServers=t}
return new t(e, n)}
...
const n=new t(e), r=Q().parseCandidate(e.candidate), o=Object.assign(n, r);
...
value:new e.RTCIceCandidate(t.candidate), writable:"false"}
), t)))}
function ee(e){
!e.RTCIceCandidate||e.RTCIceCandidate&&"relayProtocol"in e.RTCIceCandidate.prototype||d(e, "icecandidate", (e=>{
if(e.candidate){
const t=Q().parseCandidate(e.candidate.candidate);
...
if(function(e){
if(!e||!e.sdp)return!1;
const t=Q().splitSections(e.sdp);
return t.shift(), t.some((e=>{
const t=Q().parseMLine(e);
...
const o=Q().matchPrefix(e.sdp, "a=max-message-size:");
return o.length>0?r=parseInt(o[0].substr(19), 10):"firefox"===t.browser&&-1!==n&&(r=2147483637), r}
(arguments[0], e);
let o;
o=0===n&&0===r?Number.POSITIVE_INFINITY:0===n||0===r?Math.max(n, r):Math.min(n, r);
const i={
}
;
Object.defineProperty(i, "maxMessageSize", {
get:()=>o}
), this._sctp=i}
...
const n=e.send;
e.send=function(){
const r=arguments[0], o=r.length||r.size||r.byteLength;
...
if(e={
type:e.type, sdp:e.sdp}
, !e.type)switch(this.signalingState){
case"stable":case"have-local-offer":case"have-remote-pranswer":e.type="offer";
break;
...
return t}
(o), d={
browserDetails:s, commonShim:r, extractVersion:c, disableLog:p, disableWarnings:f, sdp:X}
;
switch(s.browser){
case"chrome":if(!e||!E||!i.shimChrome)return a("Chrome shim is not included in this adapter release."), d;
if(null===s.version)return a("Chrome shim can not determine version,  not shimming."), d;
a("adapter.js shimming chrome."), d.browserShim=e, ie(o, s), ae(o), g(o, s), T(o), E(o, s), S(o), w(o, s), R(o), P(o), _(o), x(o, s), Z(o), ee(o), re(o), te(o, s), ne(o), oe(o, s);
break;
case"firefox":if(!t||!I||!i.shimFirefox)return a("Firefox shim is not included in this adapter release."), d;
a("adapter.js shimming firefox."), d.browserShim=t, ie(o, s), ae(o), D(o, s), I(o, s), O(o), A(o), j(o), L(o), N(o), F(o), U(o), z(o), G(o), Z(o), re(o), te(o, s), ne(o);
break;
case"safari":if(!n||!i.shimSafari)return a("Safari shim is not included in this adapter release."), d;
a("adapter.js shimming safari."), d.browserShim=n, ie(o, s), ae(o), $(o), H(o), B(o), J(o), V(o), q(o), K(o), Y(o), Z(o), ee(o), te(o, s), ne(o), oe(o, s);
break;
default:a("Unsupported browser!")}
}
({
window:"undefined"==typeof window?void 0:window}
), a.p=`${
window.duo.static_root}
/`, window.duo.sourcesPromise.then((()=>{
Promise.all([a.e(3390), a.e(9387), a.e(3238), a.e(8659)]).then(a.bind(a, 75872)), (0, o.Au)()&&(Promise.all([a.e(3390), a.e(3238), a.e(3330)]).then(a.bind(a, 30487)), Promise.all([a.e(3390), a.e(3238), a.e(3330)]).then(a.bind(a, 63355)))}
))}
)()}
)();
//# sourceMappingURL=main_prod_723f094ac3ec256eb98b.js.map
